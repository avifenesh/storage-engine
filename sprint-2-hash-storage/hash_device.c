...
{
	global_engine = malloc(sizeof(
	    struct hash_engine)); // Userspace stub; use kmalloc in kernel
	if (!global_engine)
		return -ENOMEM;
...
// TODO: Implement full character device registration, file operations, and
// IOCTL handlers here
